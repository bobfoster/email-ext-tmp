...
import hudson.plugins.emailext.ProjectUtils;
...
public class OnlyRegressionsTest extends HudsonTestCase {
    ...
    public void testOnlyRegressionsAreShown() throws Exception {
        ...
        project.addPublisher(new JUnitResultArchiver("target/testreports/*.xml", true, null));

        ProjectUtils.addBuilder(project, new TestBuilder() {
            @Override
