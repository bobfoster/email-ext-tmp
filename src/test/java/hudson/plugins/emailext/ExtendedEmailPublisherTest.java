    ...
    extends HudsonTestCase
{
    ...
    public void testSuccessTriggerShouldNotSendEmailWhenBuildFails()
        throws Exception
    {
        ProjectUtils.addBuilder(project, new FailureBuilder() );
        ...
        throws Exception
    {
        ...
        ProjectUtils.clearBuilders(project);
        ...
        throws Exception
    {
        ...
        // abort
        ProjectUtils.clearBuilders(project);
        ProjectUtils.addBuilder(project, new MockBuilder(Result.ABORTED) );
        FreeStyleBuild build2 = project.scheduleBuild2( 0 ).get();
    ...
    public void testNotBuiltTriggerShouldSendEmailWhenNotBuilt()
        throws Exception
    {
        ProjectUtils.addBuilder(project, new MockBuilder(Result.NOT_BUILT) );
    ...
    public void testPresendScriptNoSecurity() throws Exception {
        ...
        publisher.presendScript = "for(it in Hudson.instance.items) {\n\tSystem.out.println(it.name)\n}\n";
        SuccessTrigger successTrigger = new SuccessTrigger(true, true, true, "$DEFAULT_RECIPIENTS",
            "$DEFAULT_REPLYTO", "$DEFAULT_SUBJECT", "$DEFAULT_CONTENT", "", 0);
        successTrigger.setEmail(new EmailType(){{
            setSendToRequester(true);
        ...
        assertThat( "Access was done to Hudson instance with security enabled, so we should see an error", build.getLog( 100 ),
