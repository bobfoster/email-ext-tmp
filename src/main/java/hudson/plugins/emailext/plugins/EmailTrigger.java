...
public abstract class EmailTrigger implements Describable<EmailTrigger>, ExtensionPoint {
    ...
    public static DescriptorExtensionList<EmailTrigger, EmailTriggerDescriptor> all() {
        return Hudson.getInstance().<EmailTrigger, EmailTriggerDescriptor>getDescriptorList(EmailTrigger.class);
    }
    ...
    public EmailTriggerDescriptor getDescriptor() {
        return (EmailTriggerDescriptor) Hudson.getInstance().getDescriptor(getClass());
    }
